package jeff.learning.batch.errorhandling.Skip.configs;
...
import jeff.learning.batch.errorhandling.Skip.components.CustomRetryableException;
import jeff.learning.batch.errorhandling.Skip.components.RetryItemProcessor;
import jeff.learning.batch.errorhandling.Skip.components.RetryItemWriter;
...
public class JobConfiguration {
	...
	public Step Step1(){
		return stepBuilderFactory.get("step1")
				...
				.writer(writer(null))
				.faultTolerant()
				//It will only allows to skip if the exception that is returned is the
